...
public partial class SettingsViewModel : ViewModelBase
{
    ...
    partial void OnPowerSyncUrlChanged(string value) => App.SettingsService.SetPowerSyncUrl(value);
    partial void OnPowerSyncDevTokenChanged(string value) => App.SettingsService.SetPowerSyncDevToken(value);
    partial void OnSyncBackendUrlChanged(string value) => App.SettingsService.SetSyncBackendUrl(value);
    partial void OnSupabaseUrlChanged(string value) => App.SettingsService.SetSupabaseUrl(value);
    partial void OnSupabaseApiKeyChanged(string value) => App.SettingsService.SetSupabaseApiKey(value);
